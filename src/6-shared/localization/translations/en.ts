...
export const en: typeof ru = {
  ...
  analytics: {
    ...
    details: 'details',
    monthsToLive_one: 'At this spending rate ({{avgOutcome}} per month), your balance will last for {{count}} month',
    monthsToLive_few: 'At this spending rate ({{avgOutcome}} per month), your balance will last for {{count}} months',
    monthsToLive_many: 'At this spending rate ({{avgOutcome}} per month), your balance will last for {{count}} months',
    monthsToLive_other: 'At this spending rate ({{avgOutcome}} per month), your balance will last for {{count}} months',
