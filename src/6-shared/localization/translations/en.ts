...
export const en: typeof ru = {
  ...
  transaction: {
    ...
    type_outcomeDebt: 'Lent',
    type_incomeDebt: 'Borrowed',
    amount: 'Amount',
    amountFrom: 'Amount taken',
    amountTo: 'Amount received',
    account: 'Account',
    ...
    time: 'Time',
    payee: 'Place',
    debtor: 'Who owes, or is owed',
    comment: 'Comment',
    noMerchants: 'Nothing found',
    findMerchant: 'Find or create',
    createMerchant: 'Create “{{title}}”',
    showAllMerchants: 'Show all',
    clearMerchant: 'Leave empty',
    created: 'Created: {{date}}',
    changedAgo: 'Updated: {{ago}}',
    rate: 'Rate: {{rate}}',
    ...
    btnSave: 'Save',
    btnClose: 'Close',
    btnSwap: 'Swap accounts',
    issue_amount: 'Enter an amount above zero',
    issue_sameAccount: 'Choose two different accounts',
    issue_debtor: 'Say who owes it',
