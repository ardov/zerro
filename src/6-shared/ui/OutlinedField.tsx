...
/** The two outlined field heights. They are the control's padding and nothing
...
/** Control padding inside an outlined field. The adornments
 ...
 * is focused or filled. Base UI's
