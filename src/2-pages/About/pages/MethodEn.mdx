...
<ExampleBox>
  <b>Envelopes + Banks</b>
  <br />
  For a couple of years, I tried to integrate the envelope method with banks. I
  created ~10 accounts for different spending categories and used them as
  envelopes. It involved constantly transferring money from one account to
  another, and now I'm convinced there is a more elegant solution.
</ExampleBox>
...
- **Assigned** - the amount added to or removed from the envelope this month.
- **Activity** - the real transactions in the envelope this month.
- **Available** - the money currently in the envelope, including any carryover.
- **To Be Assigned** - money outside of envelopes that still needs to be assigned. If the number is negative, it means you've assigned more than you have and need to take from somewhere.
...
<ExampleBox symbol="❌">
  ...
  <br />
  The card has 50,000₽, and we think there’s still a lot of money, so why not go
  to an expensive restaurant. Only later do we remember that we forgot to pay
  for the apartment and repay a friend's debt. In the end, we run out of money
  and go into debt again.
</ExampleBox>

<ExampleBox symbol="✅">
  <b>Money Distributed in Envelopes</b>
  <br />
  Instead of looking at the card balance, we check the “Restaurants” envelope.
  There’s only 600₽ left. Seems like we need to postpone the outing or choose a
  cheaper place - but at least we're sure other expenses are under control.
</ExampleBox>
...
<ExampleBox symbol="❌">
  ...
  <br />
  All year we pretend New Year's doesn't exist. In December, we realize the
  holiday is indeed happening and spend a large amount on gifts. The budget
  bursts at the seams, and we go into debt.
</ExampleBox>

<ExampleBox symbol="✅">
  <b>Preparing for Holidays Throughout the Year</b>
  <br />
  We know we spend about 18,000₽ on Christmas gifts each year. We create an
  envelope for gifts and put 1,500₽ in it every month. Now we don’t have to
  worry about gifts, and there’s no shock to the budget.
</ExampleBox>
...
<ExampleBox symbol="🎉">
  Now we know how budgets work and are ready to [set up
  Zerro](/about/quick-start) →
</ExampleBox>
