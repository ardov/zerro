...
<img
  ...
  className="my-8 max-w-full rounded-lg border border-solid border-[rgba(0,0,0,0.08)] [box-shadow:0_8px_32px_0_rgba(0,0,0,0.16)]"
/>
...
<DetailsBox title="How to hide a category in Zenmoney , but keep it in Zerro?">
  ...
  Now the category won't appear in Zenmoney 's expense categories but will be
  visible in Zerro, because there is money in this “envelope”.
</DetailsBox>
