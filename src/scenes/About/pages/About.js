...
export function About() {
  return (
    <>
      ...
      <h2 id="install">Как установить приложение?</h2>
      <p>
        Zerro — веб-приложение. Оно такое же классное, как и обычные приложения
        (может даже работать без сети), а устанавливается прямо из браузера ✨
      </p>
      <ul>
        <li>
          <b>Айфон.</b> В Safari «Поделиться» → «На главный экран»
        </li>
        <li>
          <b>Андроид.</b> В Chrome Три точки в верхнем правом углу → «Установить
          приложение»
        </li>
        <li>
          <b>Windows / MacOS.</b> В Chrome иконка в адресной строке «Установить
          приложение»
        </li>
      </ul>
