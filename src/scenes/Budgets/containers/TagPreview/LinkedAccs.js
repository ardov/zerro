  ...
  return (
    <>
      {linkedAccs ? (
        ...
        <Tooltip title="К категории можно привязать внебалансовый счёт, тогда все переводы на него будут считаться, как расход по этой категории. Это удобно для планирования инвестиций или погашения кредита.">
